...
function PopupDoneLimit({ onConfirm, onClose }) {
    ...
    return (
        <div className="flex justify-center items-center">
            <div
            className="fixed top-1/3 z-40 popup-window text-black bg-gray-400 border-red-500 border-4"
            >
                <button
                        ref={btnRef}
